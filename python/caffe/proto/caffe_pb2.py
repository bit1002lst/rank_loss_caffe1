...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ranking_loss_param', full_name='caffe.LayerParameter.ranking_loss_param', index=18,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='real_ranking_loss_param', full_name='caffe.LayerParameter.real_ranking_loss_param', index=19,
...
_RANKINGLOSSPARAMETER = _descriptor.Descriptor(
  name='RankingLossParameter',
  full_name='caffe.RankingLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='margin', full_name='caffe.RankingLossParameter.margin', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='version', full_name='caffe.RankingLossParameter.version', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REALRANKINGLOSSPARAMETER = _descriptor.Descriptor(
  name='RealRankingLossParameter',
  full_name='caffe.RealRankingLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='margin', full_name='caffe.RealRankingLossParameter.margin', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['ranking_loss_param'].message_type = _RANKINGLOSSPARAMETER
_LAYERPARAMETER.fields_by_name['real_ranking_loss_param'].message_type = _REALRANKINGLOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['RankingLossParameter'] = _RANKINGLOSSPARAMETER
DESCRIPTOR.message_types_by_name['RealRankingLossParameter'] = _REALRANKINGLOSSPARAMETER
...
RankingLossParameter = _reflection.GeneratedProtocolMessageType('RankingLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _RANKINGLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.RankingLossParameter)
  ))
_sym_db.RegisterMessage(RankingLossParameter)

RealRankingLossParameter = _reflection.GeneratedProtocolMessageType('RealRankingLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _REALRANKINGLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.RealRankingLossParameter)
  ))
_sym_db.RegisterMessage(RealRankingLossParameter)
